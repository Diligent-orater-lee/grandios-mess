...
import { CustomerListItem, PaginatedResponse, PaginationParams, UserListItem } from '../models';
...
export class UserApiService {
   ...
   */
  getClientUsers(params: PaginationParams = {}): Observable<PaginatedResponse<CustomerListItem>> {
    const httpParams = this.buildHttpParams(params);

    return this.http.get<PaginatedResponse<CustomerListItem>>(`${this.apiUrl}/users/clients`, { params: httpParams })
      .pipe(
        catchError(error => {
